    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Orhan Koc</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/a_jugend/orhan_g.jpg" target="_blank"><img src="bilder/a_jugend/orhan.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">11.09.1991</font></td>
          </tr>
          <tr class="roww1 entries"> 
