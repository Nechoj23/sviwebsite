    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Benjamin Heinz</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/dummy.jpg" target="_blank"> 
        <a href="bilder/AktiveSpieler/benny_g.jpg"><img src="bilder/AktiveSpieler/benny.jpg" width="240" height="320" border="0"></a> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">17.01.1982</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spitzname:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Benny, Bene</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td><font color="#0066cc">Dipl.-Ing. Maschinenbau (BA)</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">TSV Maulbronn</font></td>
          </tr>
          <tr class="roww2 entries"> 
          ...
          <tr class="roww2 entries"> 
            ...
            <td bgcolor="#CCCCCC"><font color="#0066cc">47</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
