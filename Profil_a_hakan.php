    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Hakan Bas</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/a_jugend/hakan_g.jpg" target="_blank"><img src="bilder/a_jugend/hakan.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">31.08.1990</font></td>
          </tr>
          <tr class="roww1 entries"> 
