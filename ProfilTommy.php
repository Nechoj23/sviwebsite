    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Thomas Fritsch</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/tommy3_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/tommy3.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww1 entries"> 
            ...
            <td bgcolor="#CCCCCC"><font color="#0066cc">Tommy</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td><font color="#0066cc">Techn. Betriebswirt</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">einmal SVI immer SVI</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td height="21" class="col1"><font color="#0066cc">beim SVI seit:</font></td>
          ...
          <tr class="roww2 entries"> 
            ...
            <td bgcolor="#CCCCCC"><font color="#0066cc">595</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
