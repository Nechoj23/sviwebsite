    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Angelo Vedda</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
		<td width="272" class="big"><a href="bilder/AktiveSpieler/angeloV_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/angeloV.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">12.10.1988</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spitzname:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Vendetta</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td><font color="#0066cc">Friseur</font></td>
          </tr>
          <tr class="roww1 entries"> 
          ...
          <tr class="roww2 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spiele: </br><font size="-2">(Stand 
              </font><font color="#0066cc"><font size="-2">14.07.11</font></font><font size="-2">)</font></font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">17</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
