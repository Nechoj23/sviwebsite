    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Leandro Franco</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><!--<a href="bilder/d-jugend/davide_g.JPG" target="_blank"> --><img src="bilder/d-jugend/dummy.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">03.09.00</font></td>
          </tr>
          ...
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">SV Kickers Pforzheim, SV Illingen</font></td>
          </tr>
