    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Andre Gracher</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/andreGracher_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/andreGracher.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          <tr class="roww1 entries"> 
            <td width="177" bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Position:</font></td>
            <td width="72" bgcolor="#CCCCCC"><font color="#0066cc">Mittelfeld</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Geburtsdatum:</font></td>
            <td><font color="#0066cc">02.09.1991</font></td>
          </tr>
          <tr class="roww1 entries"> 
