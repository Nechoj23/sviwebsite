    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Angelo Di Vita</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/angelo_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/angelo.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">11.12.1987</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spitzname:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Ange</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td><font color="#0066cc">&nbsp;Industriemechaniker</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">TSV Ph. Lomersheim</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td height="22" class="col1"><font color="#0066cc">beim SVI seit:</font></td>
            <td><font color="#0066cc">&nbsp;2009</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spiele: </br><font size="-2">(Stand 
              </font><font color="#0066cc"><font size="-2">14.08.12</font></font><font size="-2">)</font></font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">50</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
