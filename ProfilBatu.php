    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Batuhan Kirpi</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/dummy.jpg" target="_blank"> 
        <a href="bilder/AktiveSpieler/batu_g.jpg"><img src="bilder/AktiveSpieler/batu.jpg" width="240" height="320" border="0"></a> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">19.08.1990</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spitzname:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Batu</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td class="col1"><font color="#0066cc">Sch&uuml;ler</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherere 
              Klubs:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">VfB Vaihingen</font></td>
          </tr>
          <tr class="roww2 entries"> 
          ...
          <tr class="roww2 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spiele: </br><font size="-2">(Stand 
              27.07.13)</font></font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">27</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
