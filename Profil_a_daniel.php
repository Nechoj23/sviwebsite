    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Daniel Brenner 
          </strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/danielBrenner_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/danielBrenner.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">25.03.1992</font></td>
          </tr>
          <tr class="roww1 entries"> 
