    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Birol Aladag</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/birol_g.JPG" target="_blank"> <img src="bilder/AktiveSpieler/birol.JPG" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">18.11.1992</font></td>
          </tr>
          <tr class="roww1 entries"> 
          ...
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Germania Br&ouml;tzingen</font></td>
          </tr>
          <tr class="roww2 entries"> 
		  ...
		  <tr class="roww2 entries"> 
            ...
            <td bgcolor="#CCCCCC"><font color="#0066cc">35</font></td>
          </tr>
