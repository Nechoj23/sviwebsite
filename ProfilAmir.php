    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Amir Ben Kahla</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><img src="bilder/AktiveSpieler/amir_ben_kahla.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="287" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">19.10.1992</font></td>
          </tr>
          <tr class="roww1 entries"> 
