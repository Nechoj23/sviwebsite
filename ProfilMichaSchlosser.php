    ...
    <tr> 
      <td colspan="7" id="contentTable"> <div align="left"><strong>Michael Schlosser</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td width="272" class="big"><a href="bilder/AktiveSpieler/michaSch_neu_g.jpg" target="_blank"><img src="bilder/AktiveSpieler/michaSch_neu.jpg" width="240" height="320"> 
      </td>
      <td width="278" valign="top"><table width="261" class="profil">
          ...
          <tr class="roww2 entries"> 
            ...
            <td><font color="#0066cc">24.09.1986</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spitzname:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Micha</font></td>
          </tr>
          <tr class="roww2 entries"> 
            <td class="col1"><font color="#0066cc">Beruf:</font></td>
            <td><font color="#0066cc">Maschinenbediener</font></td>
          </tr>
          <tr class="roww1 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">f</font><font color="#0066cc">rüherer 
              Klub:</font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">Sportfreunde M&uuml;hlacker</font></td>
          </tr>
          <tr class="roww2 entries"> 
          ...
          <tr class="roww2 entries"> 
            <td bgcolor="#CCCCCC" class="col1"><font color="#0066cc">Spiele: </br><font size="-2">(Stand 
              14.08.12)</font></font></td>
            <td bgcolor="#CCCCCC"><font color="#0066cc">107</font></td>
          </tr>
        </table></td>
    </tr>
	<tr> 
